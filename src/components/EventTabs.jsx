          ...
          {events.map((event) => (
              <div className="flex mt-10 gap-10">
                ...
                <div className="shadow-2xl p-7 rounded-2xl w-full flex gap-1 ">
                  <div className="flex w-[68%] flex-col gap-5 items-start justify-between border-r border-gray-400 pr-5">
                    <div className="border-1 border-gray-400 rounded-3xl inline-flex">
                      <span className="flex items-center py-2 px-5 gap-2 font-semibold">
                        <SlCalender className="text-blue-600 text-2xl" /> {event.acf.event_start_date}
                      </span>
                      <span className="h-auto w-[1px] bg-gray-400"></span>
                      <span className="flex items-center py-2 px-5 gap-2 font-semibold">
                        <IoTimeOutline className="text-blue-600 text-2xl" /> {event.acf.event_start_time}
                      </span>
                    </div>
                    ...
                    <p className="flex gap-2 items-center">
                      <IoLocationSharp className="text-blue-600 text-2xl" /> {event.acf.location}
                    </p>
                  </div>
                    ...
                    <div className="flex items-center justify-center h-full">
                      ...
                      <div className="relative w-40 h-14">
                        ...
                        <span className="absolute left-24 z-20 h-12 w-12 border-4 border-white rounded-full bg-blue-600 text-white flex justify-center items-center font-semibold">
                          <span className="ml-[50px] tracking-[1px]">Spe </span>{" "}
